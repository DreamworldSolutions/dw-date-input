...
export class DwDateInputDemo extends LitElement {
  ...
  render() {
    return html`
      ...
      <h4>Required</h4>
      <dw-date-input label="Start date" placeholder="Enter date here" required errorMessage="Required" date=${this.value} @change=${this._onValueChange} showTodayAsDefaultDate></dw-date-input>
